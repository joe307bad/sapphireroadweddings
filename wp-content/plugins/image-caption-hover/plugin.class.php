...
class Image_Caption_Hover
{
	...
	function ich_admin_options(){
		...
		add_submenu_page('edit.php?post_type=ich_cpt', 'More Plugins WebCodingPlace', 'More Plugins', 'manage_options', 'ich_more_plugins_page', array($this, 'render_more_plugins_page') );
	}
