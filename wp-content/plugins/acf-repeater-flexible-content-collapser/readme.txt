...
**New in v1.2.0**
For Repeater or Flexible Content fields with less fields there's no need to show the collapse button. Now there's a option to show/hide the collapse button in field settings.
